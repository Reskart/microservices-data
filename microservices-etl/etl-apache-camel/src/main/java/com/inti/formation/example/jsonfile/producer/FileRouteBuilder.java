...
import com.inti.formation.example.jsonfile.mongo.ServiceStock;
			   ...
			   from("direct:process_file_processing")
				.routeId("process_file_to_mongo")
					...
					.process(exchange -> {
						...
						StockInput stock = new ObjectMapper().readValue(body, StockInput.class);
						// Sauvegarde dans mongo
						serviceStock.add(converter.convert(stock));
